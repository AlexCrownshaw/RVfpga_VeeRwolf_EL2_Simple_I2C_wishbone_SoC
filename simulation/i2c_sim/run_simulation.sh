...
xvlog --sv tb_i2c_core.sv \
      ../../src/VeeRwolf/Peripherals/i2c/i2c_core.sv

# Elaborate the design with coverage database enabled
xelab tb_i2c_core -debug typical --timescale 1ns/1ps \
      -s i2c_core -cov_db_dir $COV_DB_DIR -cov_db_name $COV_DB_NAME -R

# Simulate the design and collect functional coverage
xsim i2c_core --tclbatch run_commands.tcl --wdb tb_i2c_core.wdb --log sim_log.txt --coverage functional
