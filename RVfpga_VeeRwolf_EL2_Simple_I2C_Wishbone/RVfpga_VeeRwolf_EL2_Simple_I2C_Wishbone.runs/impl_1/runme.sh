...
HD_PWD='/home/alex/dev/rvfpga_veerwolf_el2_simple_i2c_wishbone/RVfpga_VeeRwolf_EL2_Simple_I2C_Wishbone/RVfpga_VeeRwolf_EL2_Simple_I2C_Wishbone.runs/impl_1'
cd "$HD_PWD"
